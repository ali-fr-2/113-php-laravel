...
<body>
        ...
        <div class="form-container">
            <form action="#" method="POST">
                ...
                <div class="mt-3 position-relative">
                    ...
                    <i class="fa fa-phone field_icon" aria-hidden="true"></i>
                </div>
                <div class="mt-3 position-relative">
    ...
    <?php if ($errorEmpty) { ?>
        <script>
            toastr.warning('FILL THE FORM!')
        </script>
    <?php } ?>
    <?php if ($errorPass) { ?>
        <script>
            toastr.warning('PASSWORD AND CONFIRM IS NOT THE SAME!')
        </script>
    <?php } ?>
    <?php if ($errorEmail) { ?>
        <script>
            toastr.warning('EMAIL IS REPEATED')
        </script>
    <?php } ?>
    <?php if ($errorPasLen) { ?>
        <script>
